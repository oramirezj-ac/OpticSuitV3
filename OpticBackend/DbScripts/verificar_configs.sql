...
-- Verificar que existan configuraciones en sandbox
SELECT 'sandbox' as schema, 
       nombre_optica, 
       color_primario, 
       color_secundario,
       CASE 
