...
-- 1. Crear el schema correcto 'sandbox' (si no existe)
CREATE SCHEMA IF NOT EXISTS sandbox;

-- 2. Asegurar que la tabla de configuración existe en 'sandbox'
CREATE TABLE IF NOT EXISTS sandbox.configuracion_sistema (
...
INSERT INTO sandbox.configuracion_sistema 
    (nombre_optica, eslogan, color_primario, color_secundario, color_acento, color_texto_base)
VALUES 
    ('Óptica Sandbox', 'Visión de Prueba Correcta', '#ff6600', '#ff9944', '#ffaa00', '#333333')
ON CONFLICT (id) DO NOTHING;

-- 4. Actualizar al usuario 'test@opticsuit.com' para que apunte DEFINITIVAMENTE a 'sandbox'
